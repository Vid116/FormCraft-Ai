...
export const TEMPLATES: FormTemplate[] = [
  ...
  },
  {
    ...
    name: "Party Date Poll (Spring)",
    description: "Pick every Friday/Saturday that works (April-June)",
    icon: "calendar",
    category: "Events",
    title: "Party Date Poll - Spring",
    ...
    fields: [
      ...
      field("checkbox", "Which dates work for you? (Select all that apply)", {
        description: "Grouped by week. Select every date you can make it.",
        options: [
          opt("Friday, April 3"),
          opt("Saturday, April 4"),
          opt("Friday, April 10"),
          opt("Saturday, April 11"),
          opt("Friday, April 17"),
          ...
          opt("Saturday, June 6"),
          opt("Friday, June 12"),
          opt("Saturday, June 13"),
          opt("Friday, June 19"),
          opt("Saturday, June 20"),
          opt("Friday, June 26"),
          opt("Saturday, June 27"),
        ],
      }),
    ],
  },
